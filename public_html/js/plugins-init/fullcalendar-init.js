! function(e) {
    ...
    t.prototype.onDrop = function(t, n) {
        ...
        /*t.prototype.onEventClick = function(t, n, a) {
                   var o = this,
                       i = e("<form></form>");
                   i.append("<label>Change event nam</label>"), i.append("<div class='input-group'><input class='form-control' type=text value='" + t.title + "' /><span class='input-group-btn'><button type='submit' class='btn btn-success waves-effect waves-light'><i class='fa fa-check'></i> Save</button></span></div>"), o.$modal.modal({
                       backdrop: "static"
        ...
        t.prototype.enableDrag = function() {
            ...
            var t = new Date,
                ...
                // nv = new Date(2019,9,18,10,19,30,30),
                // nv2 = new Date(nv),
                // nv3 = new Date(nv2.setMinutes(nv2.getMinutes()+40)),
                /* a = [{
                     title: "Hey!",
            ...
            //console.log("nv2",nv2);
            //console.log("nv2",nv3);
            console.log("Donner calendrier", a);
            //console.log("sffddsfds",rdvCalendrier);
            o.$calendarObj = o.$calendar.fullCalendar({
                ...
                eventClick: function(e, t, n) {
                    //console.log('clik1', e.id);
                    window.location = "index.php?p=admin.rendezVous.detail&id=" + e.id;
