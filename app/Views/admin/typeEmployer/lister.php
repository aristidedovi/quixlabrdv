...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Les employés <em class="alert alert-danger" style="font-size: 10px;">Pour supprimer un type assurez vous qu'il n'est pas de été utilisé</em></h4>
