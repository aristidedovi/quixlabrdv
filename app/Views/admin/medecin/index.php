...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">FAIRE DES PLANNING</h4>
                <div class="general-button">
                 <!--   <a href="#">
                        <button type="button" class="btn mb-1 btn-danger" disabled="disabled">Nouveau rendez-vous</button>
                    </a>-->
                    <?php for ($i=0;$i<10;$i++): ?>
                        &nbsp;
                    <?php  endfor;?>
                    <a href="#">
                        <button type="button" class="btn mb-1 btn-warning" disabled="disabled">Faire un planning</button>
                    </a>
                   <!-- <a href="#" class="btn mb-1 btn-primary" disabled="disabled">Faire un planning</a>-->
                    <?php for ($i=0;$i<10;$i++): ?>
                        &nbsp;
                    <?php  endfor;?>
                </div>
